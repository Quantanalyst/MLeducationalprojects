...
## creating a structure with 60 timesteps and 1 output
X_train = []
y_train = []
...
## since RNN needs an array as an input, we need to make those lists arrays
...
## Making the predication and visualizing the results
